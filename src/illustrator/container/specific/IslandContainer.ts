...
export interface IslandContainerOptions extends AttributeContainer {
...
/**
 * Create an Island Layout City Container
 */
export class IslandContainer extends SpecificContainer {
    ...
    constructor(key: string, options: IslandContainerOptions = {}) {
        ...
        const defaults: IslandContainerOptions = {
            "spacer.margin": 10,
            "spacer.padding": 5,
